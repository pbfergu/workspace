...
CREATE TABLE CUSTOMER_ORDER(ID BIGINT PRIMARY KEY AUTO_INCREMENT,CUSTOMER_NAME VARCHAR(255),CUSTOMER_EMAIL VARCHAR(255),STATUS VARCHAR(255));
...
CREATE TABLE PAYMENT_INFO(ID BIGINT PRIMARY KEY AUTO_INCREMENT, CREDIT_CARD_NUMBER VARCHAR(255), EXP_DATE VARCHAR(50),CVV_CODE VARCHAR(50),CARD_HOLDER_NAME VARCHAR(255), CUSTOMER_ORDER_ID_FK BIGINT);
